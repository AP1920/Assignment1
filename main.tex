...
\begin{align} \label{eq4}
    ...
    b_{3}\\}
\end{align}
Substituting values from equation \eqref{eq1} and \eqref{eq2} in above equation \eqref{eq4}, we'll get:
...
\end{align}
Substituting value from equation \eqref{eq5} in equation \eqref{eq3}, we'll get area of triangle:
