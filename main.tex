...
%
\section{Problem}
\subsection{Vector2, Example-2,6}

  
Find the area of the triangle the coordinates of whose angular points are respectively: \vec{A}\myvec{-1,2},
\vec{B}\myvec{ 2,3} and \vec{C}\myvec{4,-3}. 
