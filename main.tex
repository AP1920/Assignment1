...
%
\section{Problem}
\subsection{Vector 2, Example-2,6}

  
Find the area of the triangle the coordinates of whose angular points are respectively: $\Vec{A}\myvec{-1,2}$, $\Vec{B}\myvec{2,3}$ and $\Vec{C}\myvec{4,-3}$. 
...
\end{align}
\begin{align} \label{eq5}
    \therefore \norm {\Vec{(B-A)}\times  \Vec{(C-A)} } =\sqrt{0^2 + 0^2+ (-20)^2} = 20
\end{align}
